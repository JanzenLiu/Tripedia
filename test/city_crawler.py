...
def getCity(country, city):
	...
	if(pois):
		for poi in pois:
			poiList.append(" ".join(poi.text.split()))
	...
	return {"path": path, "name": name, "intro":intro, "attractions": poiList, "description":{"subtitles":subtitles, "bodies":bodies}}
...
countries = ["usa", "new-zealand", "china", "japan", "brazil", "egypt", "italy", "spain", "france"]
